...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/home/index.vue?vue&type=template&id=3f2c48c8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"home-page"},[_vm._ssrNode("<div class=\"banner\"><div class=\"container\"><h1 class=\"logo-font\">conduit</h1> <p>A place to share your knowledge.</p></div></div> "),_vm._ssrNode("<div class=\"container page\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-md-9\">","</div>",[_vm._ssrNode("<div class=\"feed-toggle\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\">","</ul>",[(_vm.user)?_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('nuxt-link',{staticClass:"nav-link",class:{
              ...
              params: {
                ...
                })}}},[_vm._v("\n              Read more...\n            ")])])],2)})],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"col-md-3\">","</div>",[_vm._ssrNode("<div class=\"sidebar\">","</div>",[_vm._ssrNode("<p>Popular Tags</p> "),_vm._ssrNode("<div class=\"tag-list\">","</div>",_vm._l((_vm.tags),function(item){return _c('nuxt-link',{key:item,staticClass:"tag-pill tag-default",class:{
                active: _vm.tab === 'tag',
              },attrs:{"to":{
                name: 'home',
                query: {
              ...
              },"exact":""}},[_vm._v(_vm._s(item))])}),1)],2)])],2),_vm._ssrNode(" "),_vm._ssrNode("<ul class=\"pagination\">","</ul>",_vm._l((_vm.totalPage),function(item){return _vm._ssrNode("<li"+(_vm._ssrClass("page-item",{
...
// CONCATENATED MODULE: ./pages/home/index.vue?vue&type=template&id=3f2c48c8&
...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const tag = query.tag;
    const articleRequest = tab === "global_feed" ? api_article["d" /* getArticles */] : api_article["e" /* getYourFeedArticles */];
    const [articleRes, tagRes] = await Promise.all([articleRequest({
      limit,
      offset: (page - 1) * limit,
      tag
    }), getTags()]);
  ...
  methods: {
    async onFavorite(article) {
      ...
      if (article.favorited) {
        await Object(api_article["f" /* unFavorite */])(article);
        article.favorited = false;
        article.favoritesCount += -1;
      } else {
        await Object(api_article["a" /* addFavorite */])(article);
